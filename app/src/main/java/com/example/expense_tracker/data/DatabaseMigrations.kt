...
/**
 * Encapsulates Room database migrations and initial seeding logic.
 * Extracted from AppDatabase to maintain Single Responsibility.
 */
...
open class DatabaseSeedCallback : RoomDatabase.Callback() {
